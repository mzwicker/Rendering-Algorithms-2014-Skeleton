...
public class PhotonMapTestScene {
	...
	public PhotonMapTestScene()
	{					
		outputFileName = new String("..\\images\\PhotonMapTestScene.png");
		
		// Specify integrator to be used
//		integratorFactory = new PathTracingIntegratorFactory();
		integratorFactory = new PhotonMapIntegratorFactory(true, true, true, 400000, 49, .3f, .01f);
//		integratorFactory = new DirectIlluminationIntegratorFactory();
		...
		Sphere sphere = new Sphere(new Vector3f(-.5f,-.25f,1.f), 0.5f);
...
/*		Timer timer = new Timer();
		...
		rectangle = new Rectangle(new Vector3f(-0.25f, 2.f, 0.25f), new Vector3f(0.f, 0.f, -.5f), new Vector3f(.5f, 0.f, 0.f));
		RectangleLight light = new RectangleLight(rectangle, new Spectrum(200.f, 200.f, 200.f));
		objects.add(light);
